package com.example.mentor_mentee.domain.users.service;
...
import com.example.mentor_mentee.domain.users.repository.UserRepository;
...
public class UserService {
    ...
    public InfoResponseDto getInfo(Long userId){
        ...
        // null이면 RuntimeException 에러를 던지겠다.
