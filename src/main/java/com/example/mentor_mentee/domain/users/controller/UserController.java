package com.example.mentor_mentee.domain.users.controller;
import com.example.mentor_mentee.domain.users.dto.InfoResponseDto;
import com.example.mentor_mentee.domain.users.dto.JoinRequestDto;
import com.example.mentor_mentee.domain.users.dto.PatchRequestDto;
import com.example.mentor_mentee.domain.users.service.UserService;
...
public class UserController {
    ...
    public  String join(@RequestBody @Valid JoinRequestDto dto){
        userService.join(dto); // Valid : dto 레벨에서 유효성 검증 - dto를 사용할 때 보통 사용
        return "joined";
    }
