...
public class UserController {
    ...
    // 회원가입
    @PostMapping("") // @Valid DTO 레벨에서 값이 안정적인지 검증
    ...
    @GetMapping("/{user-id}/posts") // url에서는 get 요청밖에 못함
    public UserPostResponseDto getUserPostById(@PathVariable(value = "user-id") Long id){
        UserPostResponseDto responseDto = userService.readUserPost(id);
        return responseDto;
    }
